    ...
    return (
        <div className="buy-sell">
            <div className="flex-between">
                <span>Amount(Crypto): </span><input type="number"  value={amount} onChange={e => setAmount(e.target.value)} />
            </div>
            <div className="flex-between">
                <span>Price($): </span><input type="number" value={price} onChange={e => setPrice(e.target.value)} />
            </div>
            <div className="flex-between">
                <span>total(Crypto): </span><input readOnly={true} type="number" value={price * amount} />
            </div>
