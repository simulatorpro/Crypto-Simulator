                      ...
                      <div className="flex-center">
                      ...
                      
                        {
                          user.userInfo.crypto.map((el, idx) => (
                            <>
                              <div>{el.symbol}: <input type="text" value={el.amount} readOnly={true}/></div>
                              <div>{el.symbol}(holding): <input type="text" value={el.holding} readOnly={true}/></div>
                            </>
                          ))
                        }
                        <div>USD: <input type="text" value={user.userInfo.usd} readOnly={true}/></div>
                        <div>USD(holding): <input type="text" value={user.userInfo.usd_holding} readOnly={true}/></div>
